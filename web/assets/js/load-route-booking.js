...
let bookingTicketData;
async function loadRouteList() {
    const response = await fetch("LoadSimpleRoute", {
        method: "GET",
        credentials: "include"
    });
    ...
    if (response.ok) {
        ...
        if (json.status) {
            bookingTicketData = json;
            console.log(json.routeList[1]);
            ...
            json.routeList.forEach(route => {
                ...
                console.log(route.train_id.speed_id.name);
                console.log(route.train_id.days_of_travel_id.name);
                        ...
                        <div class="card red-card bg-white text-dark shadow-sm h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-center gap-3">
                                        <span title="WiFi Available"><i class="fas fa-wifi text-success"></i></span>
                                        <span title="Food Service"><i class="fas fa-utensils text-warning"></i></span>
                                        <span title="AC Available"><i class="fas fa-snowflake text-info"></i></span>
                                        <span title="Power Outlet"><i class="fas fa-plug text-primary"></i></span>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer border-0 bg-transparent">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-danger" onclick="bookTicket(${route.id})">
                                        <i class="fas fa-ticket-alt me-2"></i> Find | සොයන්න
                                    </button>
...
function bookTicket(routeId) {
    window.location.href = `train-station-view.html?id=${routeId}`;
}
