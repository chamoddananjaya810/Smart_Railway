       ...
       Gson gson = new Gson();
        ...
        try {
            ...
            try {
                ...
                Criterion ct2 = Restrictions.eq("email_verifyed", verification_code);
                c1.add(ct1);
                c1.add(ct2);
                ...
                if (c1.list().isEmpty()) {
                    ...
                    System.out.println("No user found with email: " + email + " and verification code: " + verification_code);
                } else {
                    User user = (User) c1.list().get(0);
                    user.setEmail_verifyed("Verifyed");
