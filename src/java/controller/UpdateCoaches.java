 ...
 * @author Chamod
 */
@WebServlet(name = "UpdateCoaches", urlPatterns = {"/UpdateCoaches"})
public class UpdateCoaches extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String coachId = coach.get("coach_Id").getAsString();
        ...
        if (request.getSession().getAttribute("admin") == null) {
            ...
            Coaches c = (Coaches) s.get(Coaches.class, Integer.parseInt(coachId));
...
//            if (existingCoach != null && (c == null || existingCoach.getId() != c.getId())) {
//
...
//            } else {
            if (c != null) {
                ...
                responseJson.addProperty("status", false);
                responseJson.addProperty("message", "Coach not found");
            }
